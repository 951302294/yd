...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/ssm?user=root&password=121310&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("cin_type","Cin_Type","ssm").init();  
    }  
}